...
namespace FF_Classes
{
    ...
    partial void OnUserIDChanged();
		...
		[Association(Name="yaf_User_FF_Article", Storage="_yaf_User", ThisKey="UserID", OtherKey="UserID", IsForeignKey=true)]
    ...
    partial void OnLastMailChanged();
		...
		[Column(Storage="_WatchTopicID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_LastMail", DbType="DateTime")]
		...
		[Association(Name="yaf_Topic_yaf_WatchTopic", Storage="_yaf_Topic", ThisKey="TopicID", OtherKey="TopicID", IsForeignKey=true)]
		...
		[Association(Name="yaf_User_yaf_WatchTopic", Storage="_yaf_User", ThisKey="UserID", OtherKey="UserID", IsForeignKey=true)]
		public yaf_User yaf_User
		{
			get
			{
    ...
    partial void OnDetailsChanged();
		...
		[Association(Name="FF_League_FF_Assist", Storage="_FF_League", ThisKey="LeagueID", OtherKey="LeagueID", IsForeignKey=true)]
		...
		[Association(Name="FF_Season_FF_Assist", Storage="_FF_Season", ThisKey="SeasonID", OtherKey="SeasonID", IsForeignKey=true)]
    ...
    partial void OnMinuteChanged();
		...
		[Association(Name="FF_ChampionsGroupStage_FF_ChampionGoalScorer", Storage="_FF_ChampionsGroupStage", ThisKey="MatchID", OtherKey="ID", IsForeignKey=true)]
		...
		[Association(Name="FF_Team_FF_ChampionGoalScorer", Storage="_FF_Team", ThisKey="TeamID", OtherKey="TeamID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
    ...
    partial void OnDateChanged();
		...
		[Association(Name="FF_ChampionsGroupStage_FF_ChampionGoalScorer", Storage="_FF_ChampionGoalScorers", ThisKey="ID", OtherKey="MatchID")]
		...
		[Association(Name="FF_Season_FF_ChampionsGroupStage", Storage="_FF_Season", ThisKey="SeasonID", OtherKey="SeasonID", IsForeignKey=true)]
		public FF_Season FF_Season
		{
			get
			{
		...
		[Association(Name="FF_Team_FF_ChampionsGroupStage", Storage="_FF_Team", ThisKey="Team1ID", OtherKey="TeamID", IsForeignKey=true)]
		public FF_Team FF_Team
		{
			get
			{
		...
		[Association(Name="FF_Team_FF_ChampionsGroupStage1", Storage="_FF_Team1", ThisKey="Team2ID", OtherKey="TeamID", IsForeignKey=true)]
    ...
    partial void OnGroupIDChanged();
		...
		[Association(Name="FF_ChampionsLegaueGroup_FF_ChampionsLeagueTable", Storage="_FF_ChampionsLegaueGroup", ThisKey="GroupID", OtherKey="ID", IsForeignKey=true)]
		...
		[Association(Name="FF_Season_FF_ChampionsLeagueTable", Storage="_FF_Season", ThisKey="SeasonID", OtherKey="SeasonID", IsForeignKey=true)]
		public FF_Season FF_Season
		{
			get
			{
		...
		[Association(Name="FF_Team_FF_ChampionsLeagueTable", Storage="_FF_Team", ThisKey="TeamID", OtherKey="TeamID", IsForeignKey=true)]
		public FF_Team FF_Team
		{
			get
			{
    ...
    partial void OnGroupChanged();
		...
		[Association(Name="FF_ChampionsLegaueGroup_FF_ChampionsLeagueTable", Storage="_FF_ChampionsLeagueTables", ThisKey="ID", OtherKey="GroupID")]
    ...
    partial void OnLegChanged();
		...
		[Association(Name="FF_Season_FF_ChampionsOtherStage", Storage="_FF_Season", ThisKey="SeasonID", OtherKey="SeasonID", IsForeignKey=true)]
		public FF_Season FF_Season
		{
			get
			{
		...
		[Association(Name="FF_Team_FF_ChampionsOtherStage", Storage="_FF_Team", ThisKey="Team1ID", OtherKey="TeamID", IsForeignKey=true)]
		public FF_Team FF_Team
		{
			get
			{
		...
		[Association(Name="FF_Team_FF_ChampionsOtherStage1", Storage="_FF_Team1", ThisKey="Team2ID", OtherKey="TeamID", IsForeignKey=true)]
		public FF_Team FF_Team1
		{
			get
			{
    ...
    partial void OnOwnerIDChanged();
		...
		[Association(Name="FF_Comment_FF_UserComment", Storage="_FF_UserComments", ThisKey="ID", OtherKey="CommentID")]
		...
		[Association(Name="FF_Comment_FF_UserComment2", Storage="_FF_UserComment2s", ThisKey="ID", OtherKey="CommentID")]
	...
	[Table(Name="dbo.FF_CommentSubscriptions")]
    ...
    partial void OnOwnerIDChanged();
		...
		[Column(Storage="_UserCommentID", DbType="UniqueIdentifier NOT NULL")]
    ...
    partial void OnMinuteChanged();
		...
		[Association(Name="FF_Match_FF_GoalScorer", Storage="_FF_Match", ThisKey="MatchID", OtherKey="ID", IsForeignKey=true)]
		...
		[Association(Name="FF_Team_FF_GoalScorer", Storage="_FF_Team", ThisKey="TeamID", OtherKey="TeamID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public FF_Team FF_Team
		{
			get
			{
    ...
    partial void OnLogoURLChanged();
		...
		[Association(Name="FF_League_FF_Assist", Storage="_FF_Assists", ThisKey="LeagueID", OtherKey="LeagueID")]
		...
		[Association(Name="FF_League_FF_LeagueTable", Storage="_FF_LeagueTables", ThisKey="LeagueID", OtherKey="LeagueID")]
		...
		[Association(Name="FF_League_FF_Match", Storage="_FF_Matches", ThisKey="LeagueID", OtherKey="LeagueID")]
		...
		[Association(Name="FF_League_FF_New", Storage="_FF_News", ThisKey="LeagueID", OtherKey="LeagueID")]
		...
		[Association(Name="FF_League_FF_Team", Storage="_FF_Teams", ThisKey="LeagueID", OtherKey="LeagueID")]
		...
		[Association(Name="FF_League_FF_TopScorer", Storage="_FF_TopScorers", ThisKey="LeagueID", OtherKey="LeagueID")]
    ...
    partial void OnLeagueIDChanged();
		...
		[Association(Name="FF_League_FF_LeagueTable", Storage="_FF_League", ThisKey="LeagueID", OtherKey="LeagueID", IsForeignKey=true)]
		public FF_League FF_League
		{
			get
			{
		...
		[Association(Name="FF_Season_FF_LeagueTable", Storage="_FF_Season", ThisKey="SeasonID", OtherKey="SeasonID", IsForeignKey=true)]
		public FF_Season FF_Season
		{
			get
			{
		...
		[Association(Name="FF_Team_FF_LeagueTable", Storage="_FF_Team", ThisKey="TeamID", OtherKey="TeamID", IsForeignKey=true)]
		public FF_Team FF_Team
		{
			get
			{
    ...
    partial void OnDateChanged();
		...
		[Association(Name="FF_Match_FF_GoalScorer", Storage="_FF_GoalScorers", ThisKey="ID", OtherKey="MatchID")]
		...
		[Association(Name="FF_League_FF_Match", Storage="_FF_League", ThisKey="LeagueID", OtherKey="LeagueID", IsForeignKey=true)]
		public FF_League FF_League
		{
			get
			{
		...
		[Association(Name="FF_Season_FF_Match", Storage="_FF_Season", ThisKey="SeasonID", OtherKey="SeasonID", IsForeignKey=true)]
		public FF_Season FF_Season
		{
			get
			{
		...
		[Association(Name="FF_Team_FF_Match", Storage="_FF_Team", ThisKey="Team1ID", OtherKey="TeamID", IsForeignKey=true)]
		public FF_Team FF_Team
		{
			get
			{
		...
		[Association(Name="FF_Team_FF_Match1", Storage="_FF_Team1", ThisKey="Team2ID", OtherKey="TeamID", IsForeignKey=true)]
		public FF_Team FF_Team1
		{
			get
			{
    ...
    partial void OnSeasonIDChanged();
		...
		[Association(Name="FF_League_FF_New", Storage="_FF_League", ThisKey="LeagueID", OtherKey="LeagueID", IsForeignKey=true, DeleteRule="CASCADE")]
		public FF_League FF_League
		{
			get
			{
		...
		[Association(Name="FF_Season_FF_New", Storage="_FF_Season", ThisKey="SeasonID", OtherKey="SeasonID", IsForeignKey=true)]
		public FF_Season FF_Season
		{
			get
			{
    ...
    partial void OnDateChanged();
		...
		[Association(Name="FF_Poll_FF_Vote", Storage="_FF_Votes", ThisKey="ID", OtherKey="QuestionID")]
    ...
    partial void OnIsCurrentChanged();
		...
		[Association(Name="FF_Season_FF_Assist", Storage="_FF_Assists", ThisKey="SeasonID", OtherKey="SeasonID")]
		public EntitySet<FF_Assist> FF_Assists
		{
			get
			{
		...
		[Association(Name="FF_Season_FF_ChampionsGroupStage", Storage="_FF_ChampionsGroupStages", ThisKey="SeasonID", OtherKey="SeasonID")]
		...
		[Association(Name="FF_Season_FF_ChampionsLeagueTable", Storage="_FF_ChampionsLeagueTables", ThisKey="SeasonID", OtherKey="SeasonID")]
		public EntitySet<FF_ChampionsLeagueTable> FF_ChampionsLeagueTables
		{
			get
			{
		...
		[Association(Name="FF_Season_FF_ChampionsOtherStage", Storage="_FF_ChampionsOtherStages", ThisKey="SeasonID", OtherKey="SeasonID")]
		...
		[Association(Name="FF_Season_FF_LeagueTable", Storage="_FF_LeagueTables", ThisKey="SeasonID", OtherKey="SeasonID")]
		public EntitySet<FF_LeagueTable> FF_LeagueTables
		{
			get
			{
		...
		[Association(Name="FF_Season_FF_Match", Storage="_FF_Matches", ThisKey="SeasonID", OtherKey="SeasonID")]
		public EntitySet<FF_Match> FF_Matches
		{
			get
			{
		...
		[Association(Name="FF_Season_FF_New", Storage="_FF_News", ThisKey="SeasonID", OtherKey="SeasonID")]
		public EntitySet<FF_New> FF_News
		{
			get
			{
		...
		[Association(Name="FF_Season_FF_TopScorer", Storage="_FF_TopScorers", ThisKey="SeasonID", OtherKey="SeasonID")]
		public EntitySet<FF_TopScorer> FF_TopScorers
		{
			get
			{
    ...
    partial void OnLogoURLChanged();
		...
		[Association(Name="FF_Team_FF_ChampionGoalScorer", Storage="_FF_ChampionGoalScorers", ThisKey="TeamID", OtherKey="TeamID")]
		public EntitySet<FF_ChampionGoalScorer> FF_ChampionGoalScorers
		{
			get
			{
		...
		[Association(Name="FF_Team_FF_ChampionsGroupStage", Storage="_FF_ChampionsGroupStages", ThisKey="TeamID", OtherKey="Team1ID")]
		public EntitySet<FF_ChampionsGroupStage> FF_ChampionsGroupStages
		{
			get
			{
		...
		[Association(Name="FF_Team_FF_ChampionsGroupStage1", Storage="_FF_ChampionsGroupStages1", ThisKey="TeamID", OtherKey="Team2ID")]
		...
		[Association(Name="FF_Team_FF_ChampionsLeagueTable", Storage="_FF_ChampionsLeagueTables", ThisKey="TeamID", OtherKey="TeamID")]
		public EntitySet<FF_ChampionsLeagueTable> FF_ChampionsLeagueTables
		{
			get
			{
		...
		[Association(Name="FF_Team_FF_ChampionsOtherStage", Storage="_FF_ChampionsOtherStages", ThisKey="TeamID", OtherKey="Team1ID")]
		public EntitySet<FF_ChampionsOtherStage> FF_ChampionsOtherStages
		{
			get
			{
		...
		[Association(Name="FF_Team_FF_ChampionsOtherStage1", Storage="_FF_ChampionsOtherStages1", ThisKey="TeamID", OtherKey="Team2ID")]
		...
		[Association(Name="FF_Team_FF_GoalScorer", Storage="_FF_GoalScorers", ThisKey="TeamID", OtherKey="TeamID")]
		public EntitySet<FF_GoalScorer> FF_GoalScorers
		{
			get
			{
		...
		[Association(Name="FF_Team_FF_LeagueTable", Storage="_FF_LeagueTables", ThisKey="TeamID", OtherKey="TeamID")]
		public EntitySet<FF_LeagueTable> FF_LeagueTables
		{
			get
			{
		...
		[Association(Name="FF_Team_FF_Match", Storage="_FF_Matches", ThisKey="TeamID", OtherKey="Team1ID")]
		public EntitySet<FF_Match> FF_Matches
		{
			get
			{
		...
		[Association(Name="FF_Team_FF_Match1", Storage="_FF_Matches1", ThisKey="TeamID", OtherKey="Team2ID")]
		...
		[Association(Name="FF_League_FF_Team", Storage="_FF_League", ThisKey="LeagueID", OtherKey="LeagueID", IsForeignKey=true)]
		public FF_League FF_League
		{
			get
			{
    ...
    partial void OnWeekChanged();
		...
		[Association(Name="FF_League_FF_TopScorer", Storage="_FF_League", ThisKey="LeagueID", OtherKey="LeagueID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public FF_League FF_League
		{
			get
			{
		...
		[Association(Name="FF_Season_FF_TopScorer", Storage="_FF_Season", ThisKey="SeasonID", OtherKey="SeasonID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public FF_Season FF_Season
		{
			get
			{
    ...
    partial void OnCommentIDChanged();
		...
		[Association(Name="FF_Comment_FF_UserComment", Storage="_FF_Comment", ThisKey="CommentID", OtherKey="ID", IsForeignKey=true)]
		...
		[Association(Name="yaf_User_FF_UserComment", Storage="_yaf_User", ThisKey="UserID", OtherKey="UserID", IsForeignKey=true)]
		public yaf_User yaf_User
		{
			get
			{
    ...
    partial void OnEmailChanged();
		...
		[Association(Name="FF_Comment_FF_UserComment2", Storage="_FF_Comment", ThisKey="CommentID", OtherKey="ID", IsForeignKey=true)]
		public FF_Comment FF_Comment
		{
			get
			{
    ...
    partial void OnVotesChanged();
		...
		[Association(Name="FF_Poll_FF_Vote", Storage="_FF_Poll", ThisKey="QuestionID", OtherKey="ID", IsForeignKey=true)]
    ...
    partial void OnSortOrderChanged();
		...
		[Column(Storage="_AccessMaskID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Association(Name="yaf_AccessMask_yaf_ForumAccess", Storage="_yaf_ForumAccesses", ThisKey="AccessMaskID", OtherKey="AccessMaskID")]
		...
		[Association(Name="yaf_AccessMask_yaf_UserForum", Storage="_yaf_UserForums", ThisKey="AccessMaskID", OtherKey="AccessMaskID")]
		...
		[Association(Name="yaf_Board_yaf_AccessMask", Storage="_yaf_Board", ThisKey="BoardID", OtherKey="BoardID", IsForeignKey=true)]
    ...
    partial void OnForumPageChanged();
		...
		[Column(Storage="_SessionID", DbType="NVarChar(24) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		...
		[Column(Storage="_BoardID", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int BoardID
		{
			get
			{
		...
		[Column(Storage="_IP", DbType="VarChar(39) NOT NULL", CanBeNull=false)]
		public string IP
		{
			get
			{
		...
		[Column(Storage="_LastActive", DbType="DateTime NOT NULL")]
		...
		[Column(Storage="_Location", DbType="NVarChar(255) NOT NULL", CanBeNull=false)]
		public string Location
		{
			get
			{
		...
		[Column(Storage="_Browser", DbType="NVarChar(50)")]
		...
		[Column(Storage="_Platform", DbType="NVarChar(50)")]
		...
		[Column(Storage="_ForumPage", DbType="NVarChar(255)")]
		...
		[Association(Name="yaf_Board_yaf_Active", Storage="_yaf_Board", ThisKey="BoardID", OtherKey="BoardID", IsForeignKey=true)]
		public yaf_Board yaf_Board
		{
			get
			{
		...
		[Association(Name="yaf_Forum_yaf_Active", Storage="_yaf_Forum", ThisKey="ForumID", OtherKey="ForumID", IsForeignKey=true)]
		...
		[Association(Name="yaf_Topic_yaf_Active", Storage="_yaf_Topic", ThisKey="TopicID", OtherKey="TopicID", IsForeignKey=true)]
		public yaf_Topic yaf_Topic
		{
			get
			{
		...
		[Association(Name="yaf_User_yaf_Active", Storage="_yaf_User", ThisKey="UserID", OtherKey="UserID", IsForeignKey=true)]
		public yaf_User yaf_User
		{
			get
			{
	...
	[Table(Name="dbo.yaf_ActiveAccess")]
	public partial class yaf_ActiveAccess
	{
		...
		[Column(Storage="_IsForumModerator", DbType="Bit NOT NULL")]
		...
		[Column(Storage="_ReadAccess", DbType="Bit NOT NULL")]
		...
		[Column(Storage="_PostAccess", DbType="Bit NOT NULL")]
		...
		[Column(Storage="_ReplyAccess", DbType="Bit NOT NULL")]
		...
		[Column(Storage="_PriorityAccess", DbType="Bit NOT NULL")]
		...
		[Column(Storage="_PollAccess", DbType="Bit NOT NULL")]
		...
		[Column(Storage="_VoteAccess", DbType="Bit NOT NULL")]
		...
		[Column(Storage="_ModeratorAccess", DbType="Bit NOT NULL")]
		...
		[Column(Storage="_EditAccess", DbType="Bit NOT NULL")]
		...
		[Column(Storage="_DeleteAccess", DbType="Bit NOT NULL")]
		...
		[Column(Storage="_UploadAccess", DbType="Bit NOT NULL")]
		...
		[Column(Storage="_DownloadAccess", DbType="Bit NOT NULL")]
    ...
    partial void OnFileDataChanged();
		...
		[Column(Storage="_Bytes", DbType="Int NOT NULL")]
		public int Bytes
		{
			get
			{
		...
		[Column(Storage="_Downloads", DbType="Int NOT NULL")]
		...
		[Association(Name="yaf_Message_yaf_Attachment", Storage="_yaf_Message", ThisKey="MessageID", OtherKey="MessageID", IsForeignKey=true)]
    ...
    partial void OnUserIDChanged();
		...
		[Column(Storage="_Mask", DbType="NVarChar(15) NOT NULL", CanBeNull=false)]
		public string Mask
		{
			get
			{
		...
		[Column(Storage="_Since", DbType="DateTime NOT NULL")]
		...
		[Column(Storage="_Reason", DbType="NVarChar(128)")]
		...
		[Association(Name="yaf_Board_yaf_BannedIP", Storage="_yaf_Board", ThisKey="BoardID", OtherKey="BoardID", IsForeignKey=true)]
		public yaf_Board yaf_Board
		{
			get
			{
    ...
    partial void OnExecOrderChanged();
		...
		[Column(Storage="_BBCodeID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int BBCodeID
		{
			get
			{
		...
		[Column(Storage="_OnClickJS", DbType="NVarChar(1000)")]
		...
		[Column(Storage="_DisplayJS", DbType="NText", UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_EditJS", DbType="NText", UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_DisplayCSS", DbType="NText", UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_SearchRegex", DbType="NText", UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_ReplaceRegex", DbType="NText", UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_Variables", DbType="NVarChar(1000)")]
		...
		[Column(Storage="_UseModule", DbType="Bit")]
		...
		[Column(Storage="_ModuleClass", DbType="NVarChar(255)")]
		...
		[Column(Storage="_ExecOrder", DbType="Int NOT NULL")]
		...
		[Association(Name="yaf_Board_yaf_BBCode", Storage="_yaf_Board", ThisKey="BoardID", OtherKey="BoardID", IsForeignKey=true)]
		public yaf_Board yaf_Board
		{
			get
			{
    ...
    partial void OnBoardUIDChanged();
		...
		[Column(Storage="_AllowThreaded", DbType="Bit NOT NULL")]
		...
		[Column(Storage="_MembershipAppName", DbType="NVarChar(255)")]
		...
		[Column(Storage="_RolesAppName", DbType="NVarChar(255)")]
		...
		[Column(Storage="_BoardUID", DbType="UniqueIdentifier")]
		...
		[Association(Name="yaf_Board_yaf_AccessMask", Storage="_yaf_AccessMasks", ThisKey="BoardID", OtherKey="BoardID")]
		...
		[Association(Name="yaf_Board_yaf_Active", Storage="_yaf_Actives", ThisKey="BoardID", OtherKey="BoardID")]
		...
		[Association(Name="yaf_Board_yaf_BannedIP", Storage="_yaf_BannedIPs", ThisKey="BoardID", OtherKey="BoardID")]
		...
		[Association(Name="yaf_Board_yaf_BBCode", Storage="_yaf_BBCodes", ThisKey="BoardID", OtherKey="BoardID")]
		...
		[Association(Name="yaf_Board_yaf_Category", Storage="_yaf_Categories", ThisKey="BoardID", OtherKey="BoardID")]
		...
		[Association(Name="yaf_Board_yaf_Extension", Storage="_yaf_Extensions", ThisKey="BoardID", OtherKey="BoardId")]
		...
		[Association(Name="yaf_Board_yaf_Group", Storage="_yaf_Groups", ThisKey="BoardID", OtherKey="BoardID")]
		...
		[Association(Name="yaf_Board_yaf_NntpServer", Storage="_yaf_NntpServers", ThisKey="BoardID", OtherKey="BoardID")]
		...
		[Association(Name="yaf_Board_yaf_Rank", Storage="_yaf_Ranks", ThisKey="BoardID", OtherKey="BoardID")]
		...
		[Association(Name="yaf_Board_yaf_Registry", Storage="_yaf_Registries", ThisKey="BoardID", OtherKey="BoardID")]
		...
		[Association(Name="yaf_Board_yaf_Smiley", Storage="_yaf_Smileys", ThisKey="BoardID", OtherKey="BoardID")]
		...
		[Association(Name="yaf_Board_yaf_User", Storage="_yaf_Users", ThisKey="BoardID", OtherKey="BoardID")]
    ...
    partial void OnRequestedChanged();
		...
		[Column(Storage="_Requested", DbType="DateTime NOT NULL")]
		...
		[Association(Name="yaf_User_yaf_Buddy", Storage="_yaf_User", ThisKey="FromUserID", OtherKey="UserID", IsForeignKey=true)]
		public yaf_User yaf_User
		{
			get
			{
    ...
    partial void OnPollGroupIDChanged();
		...
		[Column(Storage="_CategoryImage", DbType="NVarChar(255)")]
		...
		[Column(Storage="_PollGroupID", DbType="Int")]
		...
		[Association(Name="yaf_Category_yaf_Forum", Storage="_yaf_Forums", ThisKey="CategoryID", OtherKey="CategoryID")]
		...
		[Association(Name="yaf_Board_yaf_Category", Storage="_yaf_Board", ThisKey="BoardID", OtherKey="BoardID", IsForeignKey=true)]
		public yaf_Board yaf_Board
		{
			get
			{
		...
		[Association(Name="yaf_PollGroupCluster_yaf_Category", Storage="_yaf_PollGroupCluster", ThisKey="PollGroupID", OtherKey="PollGroupID", IsForeignKey=true)]
    ...
    partial void OnHashChanged();
		...
		[Column(Storage="_CheckEmailID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_Hash", DbType="NVarChar(32) NOT NULL", CanBeNull=false)]
		public string Hash
		{
			get
			{
		...
		[Association(Name="yaf_User_yaf_CheckEmail", Storage="_yaf_User", ThisKey="UserID", OtherKey="UserID", IsForeignKey=true)]
		public yaf_User yaf_User
		{
			get
			{
    ...
    partial void OnMimeTypeChanged();
		...
		[Column(Storage="_ChoiceID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int ChoiceID
		{
			get
			{
		...
		[Column(Storage="_Choice", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_ObjectPath", DbType="NVarChar(255)")]
		...
		[Association(Name="yaf_Poll_yaf_Choice", Storage="_yaf_Poll", ThisKey="PollID", OtherKey="PollID", IsForeignKey=true)]
    ...
    partial void OnTypeChanged();
		...
		[Column(Storage="_EventLogID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_Source", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
		...
		[Association(Name="yaf_User_yaf_EventLog", Storage="_yaf_User", ThisKey="UserID", OtherKey="UserID", IsForeignKey=true, DeleteRule="CASCADE")]
		public yaf_User yaf_User
		{
			get
			{
    ...
    partial void OnExtensionChanged();
		...
		[Column(Storage="_ExtensionID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_Extension", DbType="NVarChar(10) NOT NULL", CanBeNull=false)]
		...
		[Association(Name="yaf_Board_yaf_Extension", Storage="_yaf_Board", ThisKey="BoardId", OtherKey="BoardID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public yaf_Board yaf_Board
		{
			get
			{
	...
	[Table(Name="dbo.yaf_FavoriteTopic")]
    ...
    partial void OnTopicIDChanged();
		...
		[Association(Name="yaf_Topic_yaf_FavoriteTopic", Storage="_yaf_Topic", ThisKey="TopicID", OtherKey="TopicID", IsForeignKey=true)]
		public yaf_Topic yaf_Topic
		{
			get
			{
		...
		[Association(Name="yaf_User_yaf_FavoriteTopic", Storage="_yaf_User", ThisKey="UserID", OtherKey="UserID", IsForeignKey=true)]
		public yaf_User yaf_User
		{
			get
			{
    ...
    partial void OnStylesChanged();
		...
		[Column(Storage="_LastUserName", DbType="NVarChar(255)")]
		...
		[Column(Storage="_NumTopics", DbType="Int NOT NULL")]
		...
		[Column(Storage="_RemoteURL", DbType="NVarChar(100)")]
		...
		[Column(Storage="_IsLocked", AutoSync=AutoSync.Always, DbType="Bit", IsDbGenerated=true, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_IsHidden", AutoSync=AutoSync.Always, DbType="Bit", IsDbGenerated=true, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_IsNoCount", AutoSync=AutoSync.Always, DbType="Bit", IsDbGenerated=true, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_IsModerated", AutoSync=AutoSync.Always, DbType="Bit", IsDbGenerated=true, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_ThemeURL", DbType="NVarChar(50)")]
		...
		[Column(Storage="_ImageURL", DbType="NVarChar(128)")]
		public string ImageURL
		{
			get
			{
		...
		[Column(Storage="_Styles", DbType="NVarChar(255)")]
		...
		[Association(Name="yaf_Forum_yaf_Active", Storage="_yaf_Actives", ThisKey="ForumID", OtherKey="ForumID")]
		public EntitySet<yaf_Active> yaf_Actives
		{
			get
			{
		...
		[Association(Name="yaf_Forum_yaf_Forum", Storage="_yaf_Forums", ThisKey="ForumID", OtherKey="ParentID")]
		public EntitySet<yaf_Forum> yaf_Forums
		{
			get
			{
		...
		[Association(Name="yaf_Forum_yaf_ForumAccess", Storage="_yaf_ForumAccesses", ThisKey="ForumID", OtherKey="ForumID")]
		public EntitySet<yaf_ForumAccess> yaf_ForumAccesses
		{
			get
			{
		...
		[Association(Name="yaf_Forum_yaf_NntpForum", Storage="_yaf_NntpForums", ThisKey="ForumID", OtherKey="ForumID")]
		...
		[Association(Name="yaf_Forum_yaf_Topic", Storage="_yaf_Topics", ThisKey="ForumID", OtherKey="ForumID")]
		...
		[Association(Name="yaf_Forum_yaf_UserForum", Storage="_yaf_UserForums", ThisKey="ForumID", OtherKey="ForumID")]
		public EntitySet<yaf_UserForum> yaf_UserForums
		{
			get
			{
		...
		[Association(Name="yaf_Forum_yaf_WatchForum", Storage="_yaf_WatchForums", ThisKey="ForumID", OtherKey="ForumID")]
		...
		[Association(Name="yaf_Category_yaf_Forum", Storage="_yaf_Category", ThisKey="CategoryID", OtherKey="CategoryID", IsForeignKey=true)]
		...
		[Association(Name="yaf_Forum_yaf_Forum", Storage="_yaf_Forum1", ThisKey="ParentID", OtherKey="ForumID", IsForeignKey=true)]
		...
		[Association(Name="yaf_Message_yaf_Forum", Storage="_yaf_Message", ThisKey="LastMessageID", OtherKey="MessageID", IsForeignKey=true)]
		public yaf_Message yaf_Message
		{
			get
			{
		...
		[Association(Name="yaf_PollGroupCluster_yaf_Forum", Storage="_yaf_PollGroupCluster", ThisKey="PollGroupID", OtherKey="PollGroupID", IsForeignKey=true)]
		public yaf_PollGroupCluster yaf_PollGroupCluster
		{
			get
			{
		...
		[Association(Name="yaf_Topic_yaf_Forum", Storage="_yaf_Topic", ThisKey="LastTopicID", OtherKey="TopicID", IsForeignKey=true)]
		public yaf_Topic yaf_Topic
		{
			get
			{
		...
		[Association(Name="yaf_User_yaf_Forum", Storage="_yaf_User", ThisKey="LastUserID", OtherKey="UserID", IsForeignKey=true)]
		public yaf_User yaf_User
		{
			get
			{
	...
	[Table(Name="dbo.yaf_ForumAccess")]
    ...
    partial void OnAccessMaskIDChanged();
		...
		[Column(Storage="_ForumID", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int ForumID
		{
			get
			{
		...
		[Column(Storage="_AccessMaskID", DbType="Int NOT NULL")]
		public int AccessMaskID
		{
			get
			{
		...
		[Association(Name="yaf_AccessMask_yaf_ForumAccess", Storage="_yaf_AccessMask", ThisKey="AccessMaskID", OtherKey="AccessMaskID", IsForeignKey=true)]
		...
		[Association(Name="yaf_Forum_yaf_ForumAccess", Storage="_yaf_Forum", ThisKey="ForumID", OtherKey="ForumID", IsForeignKey=true)]
		public yaf_Forum yaf_Forum
		{
			get
			{
		...
		[Association(Name="yaf_Group_yaf_ForumAccess", Storage="_yaf_Group", ThisKey="GroupID", OtherKey="GroupID", IsForeignKey=true)]
    ...
    partial void OnUsrAlbumImagesChanged();
		...
		[Column(Storage="_PMLimit", DbType="Int")]
		...
		[Column(Storage="_Style", DbType="NVarChar(255)")]
		public string Style
		{
			get
			{
		...
		[Column(Storage="_Description", DbType="NVarChar(128)")]
		public string Description
		{
			get
			{
		...
		[Column(Storage="_UsrSigChars", DbType="Int NOT NULL")]
		...
		[Column(Storage="_UsrSigBBCodes", DbType="NVarChar(255)")]
		...
		[Column(Storage="_UsrSigHTMLTags", DbType="NVarChar(255)")]
		...
		[Column(Storage="_UsrAlbums", DbType="Int NOT NULL")]
		...
		[Column(Storage="_UsrAlbumImages", DbType="Int NOT NULL")]
		...
		[Association(Name="yaf_Group_yaf_ForumAccess", Storage="_yaf_ForumAccesses", ThisKey="GroupID", OtherKey="GroupID")]
		public EntitySet<yaf_ForumAccess> yaf_ForumAccesses
		{
			get
			{
		...
		[Association(Name="yaf_Group_yaf_UserGroup", Storage="_yaf_UserGroups", ThisKey="GroupID", OtherKey="GroupID")]
		...
		[Association(Name="yaf_Board_yaf_Group", Storage="_yaf_Board", ThisKey="BoardID", OtherKey="BoardID", IsForeignKey=true)]
		public yaf_Board yaf_Board
		{
			get
			{
	...
	public partial class yaf_GroupMedal
	{
		...
		[Column(Storage="_MedalID", DbType="Int NOT NULL")]
		public int MedalID
		{
			get
			{
		...
		[Column(Storage="_Message", DbType="NVarChar(100)")]
		...
		[Column(Storage="_OnlyRibbon", DbType="Bit NOT NULL")]
		...
		[Column(Storage="_SortOrder", DbType="TinyInt NOT NULL")]
    ...
    partial void OnIgnoredUserIDChanged();
		...
		[Column(Storage="_IgnoredUserID", DbType="Int NOT NULL", IsPrimaryKey=true)]
    ...
    partial void OnProcessIDChanged();
		...
		[Column(Storage="_FromUser", DbType="NVarChar(255) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_FromUserName", DbType="NVarChar(255)")]
		...
		[Column(Storage="_ToUser", DbType="NVarChar(255) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_ToUserName", DbType="NVarChar(255)")]
		...
		[Column(Storage="_Subject", DbType="NVarChar(100) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_BodyHtml", DbType="NText", UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_SendTries", DbType="Int NOT NULL")]
		...
		[Column(Storage="_SendAttempt", DbType="DateTime")]
    ...
    partial void OnFlagsChanged();
		...
		[Column(Storage="_MedalID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int MedalID
		{
			get
			{
		...
		[Column(Storage="_Message", DbType="NVarChar(100) NOT NULL", CanBeNull=false)]
		public string Message
		{
			get
			{
		...
		[Column(Storage="_MedalURL", DbType="NVarChar(250) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_RibbonURL", DbType="NVarChar(250)")]
		...
		[Column(Storage="_SmallMedalURL", DbType="NVarChar(250) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_SmallRibbonURL", DbType="NVarChar(250)")]
		...
		[Column(Storage="_SmallMedalWidth", DbType="SmallInt NOT NULL")]
		...
		[Column(Storage="_SmallMedalHeight", DbType="SmallInt NOT NULL")]
		...
		[Column(Storage="_SmallRibbonWidth", DbType="SmallInt")]
		...
		[Column(Storage="_SmallRibbonHeight", DbType="SmallInt")]
    ...
    partial void OnEditedByChanged();
		...
		[Column(Storage="_IsDeleted", AutoSync=AutoSync.Always, DbType="Bit", IsDbGenerated=true, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_IsApproved", AutoSync=AutoSync.Always, DbType="Bit", IsDbGenerated=true, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_EditedBy", DbType="Int")]
		...
		[Association(Name="yaf_Message_yaf_Attachment", Storage="_yaf_Attachments", ThisKey="MessageID", OtherKey="MessageID")]
		...
		[Association(Name="yaf_Message_yaf_Forum", Storage="_yaf_Forums", ThisKey="MessageID", OtherKey="LastMessageID")]
		public EntitySet<yaf_Forum> yaf_Forums
		{
			get
			{
		...
		[Association(Name="yaf_Message_yaf_Message", Storage="_yaf_Messages", ThisKey="MessageID", OtherKey="ReplyTo")]
		...
		[Association(Name="yaf_Message_yaf_Topic", Storage="_yaf_Topics", ThisKey="MessageID", OtherKey="LastMessageID")]
		public EntitySet<yaf_Topic> yaf_Topics
		{
			get
			{
		...
		[Association(Name="yaf_Message_yaf_Message", Storage="_yaf_Message1", ThisKey="ReplyTo", OtherKey="MessageID", IsForeignKey=true)]
		...
		[Association(Name="yaf_Topic_yaf_Message", Storage="_yaf_Topic", ThisKey="TopicID", OtherKey="TopicID", IsForeignKey=true)]
		public yaf_Topic yaf_Topic
		{
			get
			{
		...
		[Association(Name="yaf_User_yaf_Message", Storage="_yaf_User", ThisKey="UserID", OtherKey="UserID", IsForeignKey=true)]
		public yaf_User yaf_User
		{
			get
			{
	...
	[Table(Name="dbo.yaf_MessageHistory")]
	public partial class yaf_MessageHistory
	{
		...
		[Column(Storage="_MessageHistoryID", DbType="UniqueIdentifier NOT NULL")]
	...
	[Table(Name="dbo.yaf_MessageReported")]
	public partial class yaf_MessageReported
	{
		...
		[Column(Storage="_Resolved", DbType="Bit")]
		...
		[Column(Storage="_ResolvedBy", DbType="Int")]
		...
		[Column(Storage="_ResolvedDate", DbType="DateTime")]
	...
	[Table(Name="dbo.yaf_MessageReportedAudit")]
	public partial class yaf_MessageReportedAudit
	{
		...
		[Column(Storage="_LogID", AutoSync=AutoSync.Always, DbType="Int NOT NULL IDENTITY", IsDbGenerated=true)]
		public int LogID
		{
			get
			{
		...
		[Column(Storage="_MessageID", DbType="Int")]
		...
		[Column(Storage="_Reported", DbType="DateTime")]
		...
		[Column(Storage="_ReportedNumber", DbType="Int NOT NULL")]
		...
		[Column(Storage="_ReportText", DbType="NVarChar(4000)")]
    ...
    partial void OnActiveChanged();
		...
		[Column(Storage="_NntpForumID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_NntpServerID", DbType="Int NOT NULL")]
		...
		[Column(Storage="_LastMessageNo", DbType="Int NOT NULL")]
		...
		[Association(Name="yaf_NntpForum_yaf_NntpTopic", Storage="_yaf_NntpTopics", ThisKey="NntpForumID", OtherKey="NntpForumID")]
		...
		[Association(Name="yaf_Forum_yaf_NntpForum", Storage="_yaf_Forum", ThisKey="ForumID", OtherKey="ForumID", IsForeignKey=true)]
		public yaf_Forum yaf_Forum
		{
			get
			{
		...
		[Association(Name="yaf_NntpServer_yaf_NntpForum", Storage="_yaf_NntpServer", ThisKey="NntpServerID", OtherKey="NntpServerID", IsForeignKey=true)]
    ...
    partial void OnUserPassChanged();
		...
		[Column(Storage="_NntpServerID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int NntpServerID
		{
			get
			{
		...
		[Association(Name="yaf_NntpServer_yaf_NntpForum", Storage="_yaf_NntpForums", ThisKey="NntpServerID", OtherKey="NntpServerID")]
		public EntitySet<yaf_NntpForum> yaf_NntpForums
		{
			get
			{
		...
		[Association(Name="yaf_Board_yaf_NntpServer", Storage="_yaf_Board", ThisKey="BoardID", OtherKey="BoardID", IsForeignKey=true)]
		public yaf_Board yaf_Board
		{
			get
			{
    ...
    partial void OnTopicIDChanged();
		...
		[Column(Storage="_NntpTopicID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_NntpForumID", DbType="Int NOT NULL")]
		public int NntpForumID
		{
			get
			{
		...
		[Column(Storage="_Thread", DbType="Char(32) NOT NULL", CanBeNull=false)]
		...
		[Association(Name="yaf_NntpForum_yaf_NntpTopic", Storage="_yaf_NntpForum", ThisKey="NntpForumID", OtherKey="NntpForumID", IsForeignKey=true)]
		...
		[Association(Name="yaf_Topic_yaf_NntpTopic", Storage="_yaf_Topic", ThisKey="TopicID", OtherKey="TopicID", IsForeignKey=true)]
		public yaf_Topic yaf_Topic
		{
			get
			{
    ...
    partial void OnFlagsChanged();
		...
		[Column(Storage="_PMessageID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Association(Name="yaf_PMessage_yaf_UserPMessage", Storage="_yaf_UserPMessages", ThisKey="PMessageID", OtherKey="PMessageID")]
		...
		[Association(Name="yaf_User_yaf_PMessage", Storage="_yaf_User", ThisKey="FromUserID", OtherKey="UserID", IsForeignKey=true)]
		public yaf_User yaf_User
		{
			get
			{
    ...
    partial void OnAllowSkipVoteChanged();
		...
		[Column(Storage="_Question", DbType="VarChar(255) NOT NULL", CanBeNull=false)]
		public string Question
		{
			get
			{
		...
		[Column(Storage="_Closes", DbType="DateTime")]
		...
		[Column(Storage="_IsClosedBound", AutoSync=AutoSync.Always, DbType="Bit", IsDbGenerated=true, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_AllowMultipleChoices", AutoSync=AutoSync.Always, DbType="Bit", IsDbGenerated=true, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_ShowVoters", AutoSync=AutoSync.Always, DbType="Bit", IsDbGenerated=true, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_AllowSkipVote", AutoSync=AutoSync.Always, DbType="Bit", IsDbGenerated=true, UpdateCheck=UpdateCheck.Never)]
		...
		[Association(Name="yaf_Poll_yaf_Choice", Storage="_yaf_Choices", ThisKey="PollID", OtherKey="PollID")]
		...
		[Association(Name="yaf_Poll_yaf_PollVote", Storage="_yaf_PollVotes", ThisKey="PollID", OtherKey="PollID")]
		...
		[Association(Name="yaf_PollGroupCluster_yaf_Poll", Storage="_yaf_PollGroupCluster", ThisKey="PollGroupID", OtherKey="PollGroupID", IsForeignKey=true, DeleteRule="CASCADE")]
		public yaf_PollGroupCluster yaf_PollGroupCluster
		{
			get
			{
	...
	[Table(Name="dbo.yaf_PollGroupCluster")]
    ...
    partial void OnIsBoundChanged();
		...
		[Column(Storage="_PollGroupID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_IsBound", AutoSync=AutoSync.Always, DbType="Bit", IsDbGenerated=true, UpdateCheck=UpdateCheck.Never)]
		...
		[Association(Name="yaf_PollGroupCluster_yaf_Category", Storage="_yaf_Categories", ThisKey="PollGroupID", OtherKey="PollGroupID")]
		public EntitySet<yaf_Category> yaf_Categories
		{
			get
			{
		...
		[Association(Name="yaf_PollGroupCluster_yaf_Forum", Storage="_yaf_Forums", ThisKey="PollGroupID", OtherKey="PollGroupID")]
		public EntitySet<yaf_Forum> yaf_Forums
		{
			get
			{
		...
		[Association(Name="yaf_PollGroupCluster_yaf_Poll", Storage="_yaf_Polls", ThisKey="PollGroupID", OtherKey="PollGroupID")]
		...
		[Association(Name="yaf_PollGroupCluster_yaf_Topic", Storage="_yaf_Topics", ThisKey="PollGroupID", OtherKey="PollID")]
		public EntitySet<yaf_Topic> yaf_Topics
		{
			get
			{
    ...
    partial void OnChoiceIDChanged();
		...
		[Column(Storage="_PollVoteID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_RemoteIP", DbType="VarChar(57)")]
		...
		[Column(Storage="_ChoiceID", DbType="Int")]
		...
		[Association(Name="yaf_Poll_yaf_PollVote", Storage="_yaf_Poll", ThisKey="PollID", OtherKey="PollID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public yaf_Poll yaf_Poll
		{
			get
			{
	...
	[Table(Name="dbo.yaf_prov_Application")]
    ...
    partial void OnDescriptionChanged();
		...
		[Column(Storage="_ApplicationName", DbType="NVarChar(256)")]
		...
		[Column(Storage="_ApplicationNameLwd", DbType="NVarChar(256)")]
	...
	[Table(Name="dbo.yaf_prov_Membership")]
    ...
    partial void OnCommentChanged();
		...
		[Column(Storage="_UserID", DbType="NVarChar(64) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		...
		[Column(Storage="_UsernameLwd", DbType="NVarChar(256) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_Password", DbType="NVarChar(256)")]
		...
		[Column(Storage="_PasswordSalt", DbType="NVarChar(256)")]
		...
		[Column(Storage="_PasswordFormat", DbType="NVarChar(256)")]
		...
		[Column(Storage="_EmailLwd", DbType="NVarChar(256)")]
		...
		[Column(Storage="_LastPasswordChange", DbType="DateTime")]
		...
		[Column(Storage="_LastLockOut", DbType="DateTime")]
		...
		[Column(Storage="_FailedPasswordAttempts", DbType="Int")]
		...
		[Column(Storage="_FailedAnswerAttempts", DbType="Int")]
		...
		[Column(Storage="_FailedPasswordWindow", DbType="DateTime")]
		...
		[Column(Storage="_FailedAnswerWindow", DbType="DateTime")]
		...
		[Column(Storage="_Joined", DbType="DateTime")]
	...
	[Table(Name="dbo.yaf_prov_Profile")]
    ...
    partial void OnOccupationChanged();
		...
		[Column(Storage="_RealName", DbType="NVarChar(255)")]
		...
		[Column(Storage="_BlogServiceUrl", DbType="NVarChar(255)")]
		...
		[Column(Storage="_Blog", DbType="NVarChar(255)")]
		public string Blog
		{
			get
			{
		...
		[Column(Storage="_MSN", DbType="NVarChar(255)")]
		public string MSN
		{
			get
			{
		...
		[Column(Storage="_BlogServiceUsername", DbType="NVarChar(255)")]
		...
		[Column(Storage="_BlogServicePassword", DbType="NVarChar(255)")]
		...
		[Column(Storage="_AIM", DbType="NVarChar(255)")]
		public string AIM
		{
			get
			{
		...
		[Column(Storage="_GoogleTalk", DbType="NVarChar(255)")]
		...
		[Column(Storage="_Interests", DbType="NVarChar(400)")]
		...
		[Column(Storage="_Homepage", DbType="NVarChar(255)")]
		...
		[Column(Storage="_Skype", DbType="NVarChar(255)")]
		public string Skype
		{
			get
			{
		...
		[Column(Storage="_ICQ", DbType="NVarChar(255)")]
		public string ICQ
		{
			get
			{
		...
		[Column(Storage="_XMPP", DbType="NVarChar(255)")]
		public string XMPP
		{
			get
			{
		...
		[Column(Storage="_YIM", DbType="NVarChar(255)")]
		public string YIM
		{
			get
			{
		...
		[Column(Storage="_Occupation", DbType="NVarChar(400)")]
    ...
    partial void OnRoleNameLwdChanged();
		...
		[Column(Storage="_RoleNameLwd", DbType="NVarChar(256) NOT NULL", CanBeNull=false)]
	...
	[Table(Name="dbo.yaf_prov_RoleMembership")]
	public partial class yaf_prov_RoleMembership
	{
		...
		[Column(Storage="_UserID", DbType="NVarChar(64) NOT NULL", CanBeNull=false)]
		public string UserID
		{
			get
			{
    ...
    partial void OnUsrAlbumImagesChanged();
		...
		[Column(Storage="_MinPosts", DbType="Int")]
		...
		[Column(Storage="_RankImage", DbType="NVarChar(50)")]
		...
		[Association(Name="yaf_Rank_yaf_User", Storage="_yaf_Users", ThisKey="RankID", OtherKey="RankID")]
		public EntitySet<yaf_User> yaf_Users
		{
			get
			{
		...
		[Association(Name="yaf_Board_yaf_Rank", Storage="_yaf_Board", ThisKey="BoardID", OtherKey="BoardID", IsForeignKey=true)]
		public yaf_Board yaf_Board
		{
			get
			{
    ...
    partial void OnBoardIDChanged();
		...
		[Column(Storage="_RegistryID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_Value", DbType="NText", UpdateCheck=UpdateCheck.Never)]
		public string Value
		{
			get
			{
		...
		[Column(Storage="_BoardID", DbType="Int")]
		...
		[Association(Name="yaf_Board_yaf_Registry", Storage="_yaf_Board", ThisKey="BoardID", OtherKey="BoardID", IsForeignKey=true, DeleteRule="CASCADE")]
		public yaf_Board yaf_Board
		{
			get
			{
	...
	[Table(Name="dbo.yaf_Replace_Words")]
    ...
    partial void OnGoodWordChanged();
		...
		[Column(Storage="_BadWord", DbType="NVarChar(255)")]
		...
		[Column(Storage="_GoodWord", DbType="NVarChar(255)")]
	...
	[Table(Name="dbo.yaf_ShoutboxMessage")]
    ...
    partial void OnIPChanged();
		...
		[Column(Storage="_ShoutBoxMessageID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
    ...
    partial void OnSortOrderChanged();
		...
		[Column(Storage="_SmileyID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int SmileyID
		{
			get
			{
		...
		[Column(Storage="_Emoticon", DbType="NVarChar(50)")]
		...
		[Association(Name="yaf_Board_yaf_Smiley", Storage="_yaf_Board", ThisKey="BoardID", OtherKey="BoardID", IsForeignKey=true)]
		public yaf_Board yaf_Board
		{
			get
			{
    ...
    partial void OnThanksDateChanged();
		...
		[Column(Storage="_ThanksID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int ThanksID
		{
			get
			{
		...
		[Column(Storage="_ThanksFromUserID", DbType="Int NOT NULL")]
		...
		[Column(Storage="_ThanksToUserID", DbType="Int NOT NULL")]
		...
		[Column(Storage="_ThanksDate", DbType="SmallDateTime NOT NULL")]
		...
		[Association(Name="yaf_User_yaf_Thank", Storage="_yaf_User", ThisKey="ThanksFromUserID", OtherKey="UserID", IsForeignKey=true)]
		public yaf_User yaf_User
		{
			get
			{
    ...
    partial void OnTopicImageChanged();
		...
		[Column(Storage="_IsQuestion", AutoSync=AutoSync.Always, DbType="Bit", IsDbGenerated=true, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_AnswerMessageId", DbType="Int")]
		...
		[Column(Storage="_LastMessageFlags", DbType="Int")]
		...
		[Column(Storage="_TopicImage", DbType="NVarChar(255)")]
		...
		[Association(Name="yaf_Topic_yaf_WatchTopic", Storage="_yaf_WatchTopics", ThisKey="TopicID", OtherKey="TopicID")]
		...
		[Association(Name="yaf_Topic_yaf_Active", Storage="_yaf_Actives", ThisKey="TopicID", OtherKey="TopicID")]
		public EntitySet<yaf_Active> yaf_Actives
		{
			get
			{
		...
		[Association(Name="yaf_Topic_yaf_FavoriteTopic", Storage="_yaf_FavoriteTopics", ThisKey="TopicID", OtherKey="TopicID")]
		...
		[Association(Name="yaf_Topic_yaf_Forum", Storage="_yaf_Forums", ThisKey="TopicID", OtherKey="LastTopicID")]
		public EntitySet<yaf_Forum> yaf_Forums
		{
			get
			{
		...
		[Association(Name="yaf_Topic_yaf_Message", Storage="_yaf_Messages", ThisKey="TopicID", OtherKey="TopicID")]
		public EntitySet<yaf_Message> yaf_Messages
		{
			get
			{
		...
		[Association(Name="yaf_Topic_yaf_NntpTopic", Storage="_yaf_NntpTopics", ThisKey="TopicID", OtherKey="TopicID")]
		public EntitySet<yaf_NntpTopic> yaf_NntpTopics
		{
			get
			{
		...
		[Association(Name="yaf_Topic_yaf_Topic", Storage="_yaf_Topics", ThisKey="TopicID", OtherKey="TopicMovedID")]
		public EntitySet<yaf_Topic> yaf_Topics
		{
			get
			{
		...
		[Association(Name="yaf_Forum_yaf_Topic", Storage="_yaf_Forum", ThisKey="ForumID", OtherKey="ForumID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public yaf_Forum yaf_Forum
		{
			get
			{
		...
		[Association(Name="yaf_Message_yaf_Topic", Storage="_yaf_Message", ThisKey="LastMessageID", OtherKey="MessageID", IsForeignKey=true)]
		public yaf_Message yaf_Message
		{
			get
			{
		...
		[Association(Name="yaf_PollGroupCluster_yaf_Topic", Storage="_yaf_PollGroupCluster", ThisKey="PollID", OtherKey="PollGroupID", IsForeignKey=true)]
		public yaf_PollGroupCluster yaf_PollGroupCluster
		{
			get
			{
		...
		[Association(Name="yaf_Topic_yaf_Topic", Storage="_yaf_Topic1", ThisKey="TopicMovedID", OtherKey="TopicID", IsForeignKey=true)]
		...
		[Association(Name="yaf_User_yaf_Topic", Storage="_yaf_User", ThisKey="UserID", OtherKey="UserID", IsForeignKey=true)]
		public yaf_User yaf_User
		{
			get
			{
		...
		[Association(Name="yaf_User_yaf_Topic1", Storage="_yaf_User1", ThisKey="LastUserID", OtherKey="UserID", IsForeignKey=true)]
    ...
    partial void OnCultureChanged();
		...
		[Column(Storage="_IP", DbType="VarChar(39)")]
		public string IP
		{
			get
			{
		...
		[Column(Storage="_Avatar", DbType="NVarChar(255)")]
		...
		[Column(Storage="_Signature", DbType="NText", UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_AvatarImage", DbType="Image", UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_AvatarImageType", DbType="NVarChar(50)")]
		...
		[Column(Storage="_RankID", DbType="Int NOT NULL")]
		public int RankID
		{
			get
			{
		...
		[Column(Storage="_Suspended", DbType="DateTime")]
		...
		[Column(Storage="_LanguageFile", DbType="NVarChar(50)")]
		...
		[Column(Storage="_ThemeFile", DbType="NVarChar(50)")]
		...
		[Column(Storage="_TextEditor", DbType="NVarChar(50)")]
		...
		[Column(Storage="_OverrideDefaultThemes", DbType="Bit NOT NULL")]
		...
		[Column(Storage="_PMNotification", DbType="Bit NOT NULL")]
		...
		[Column(Storage="_AutoWatchTopics", DbType="Bit NOT NULL")]
		...
		[Column(Storage="_DailyDigest", DbType="Bit NOT NULL")]
		...
		[Column(Storage="_NotificationType", DbType="Int")]
		...
		[Column(Storage="_IsActiveExcluded", AutoSync=AutoSync.Always, DbType="Bit", IsDbGenerated=true, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_Culture", DbType="Char(5)")]
		...
		[Association(Name="yaf_User_FF_Article", Storage="_FF_Articles", ThisKey="UserID", OtherKey="UserID")]
		...
		[Association(Name="yaf_User_yaf_WatchTopic", Storage="_yaf_WatchTopics", ThisKey="UserID", OtherKey="UserID")]
		public EntitySet<yaf_WatchTopic> yaf_WatchTopics
		{
			get
			{
		...
		[Association(Name="yaf_User_FF_UserComment", Storage="_FF_UserComments", ThisKey="UserID", OtherKey="UserID")]
		public EntitySet<FF_UserComment> FF_UserComments
		{
			get
			{
		...
		[Association(Name="yaf_User_yaf_Active", Storage="_yaf_Actives", ThisKey="UserID", OtherKey="UserID")]
		public EntitySet<yaf_Active> yaf_Actives
		{
			get
			{
		...
		[Association(Name="yaf_User_yaf_Buddy", Storage="_yaf_Buddies", ThisKey="UserID", OtherKey="FromUserID")]
		...
		[Association(Name="yaf_User_yaf_CheckEmail", Storage="_yaf_CheckEmails", ThisKey="UserID", OtherKey="UserID")]
		...
		[Association(Name="yaf_User_yaf_EventLog", Storage="_yaf_EventLogs", ThisKey="UserID", OtherKey="UserID")]
		...
		[Association(Name="yaf_User_yaf_FavoriteTopic", Storage="_yaf_FavoriteTopics", ThisKey="UserID", OtherKey="UserID")]
		public EntitySet<yaf_FavoriteTopic> yaf_FavoriteTopics
		{
			get
			{
		...
		[Association(Name="yaf_User_yaf_Forum", Storage="_yaf_Forums", ThisKey="UserID", OtherKey="LastUserID")]
		public EntitySet<yaf_Forum> yaf_Forums
		{
			get
			{
		...
		[Association(Name="yaf_User_yaf_Message", Storage="_yaf_Messages", ThisKey="UserID", OtherKey="UserID")]
		public EntitySet<yaf_Message> yaf_Messages
		{
			get
			{
		...
		[Association(Name="yaf_User_yaf_PMessage", Storage="_yaf_PMessages", ThisKey="UserID", OtherKey="FromUserID")]
		...
		[Association(Name="yaf_User_yaf_Thank", Storage="_yaf_Thanks", ThisKey="UserID", OtherKey="ThanksFromUserID")]
		...
		[Association(Name="yaf_User_yaf_Topic", Storage="_yaf_Topics", ThisKey="UserID", OtherKey="UserID")]
		public EntitySet<yaf_Topic> yaf_Topics
		{
			get
			{
		...
		[Association(Name="yaf_User_yaf_Topic1", Storage="_yaf_Topics1", ThisKey="UserID", OtherKey="LastUserID")]
		...
		[Association(Name="yaf_User_yaf_UserForum", Storage="_yaf_UserForums", ThisKey="UserID", OtherKey="UserID")]
		public EntitySet<yaf_UserForum> yaf_UserForums
		{
			get
			{
		...
		[Association(Name="yaf_User_yaf_UserGroup", Storage="_yaf_UserGroups", ThisKey="UserID", OtherKey="UserID")]
		public EntitySet<yaf_UserGroup> yaf_UserGroups
		{
			get
			{
		...
		[Association(Name="yaf_User_yaf_UserPMessage", Storage="_yaf_UserPMessages", ThisKey="UserID", OtherKey="UserID")]
		public EntitySet<yaf_UserPMessage> yaf_UserPMessages
		{
			get
			{
		...
		[Association(Name="yaf_User_yaf_WatchForum", Storage="_yaf_WatchForums", ThisKey="UserID", OtherKey="UserID")]
		public EntitySet<yaf_WatchForum> yaf_WatchForums
		{
			get
			{
		...
		[Association(Name="yaf_Board_yaf_User", Storage="_yaf_Board", ThisKey="BoardID", OtherKey="BoardID", IsForeignKey=true)]
		public yaf_Board yaf_Board
		{
			get
			{
		...
		[Association(Name="yaf_Rank_yaf_User", Storage="_yaf_Rank", ThisKey="RankID", OtherKey="RankID", IsForeignKey=true)]
    ...
    partial void OnUpdatedChanged();
		...
		[Column(Storage="_CoverImageID", DbType="Int")]
		...
		[Association(Name="yaf_UserAlbum_yaf_UserAlbumImage", Storage="_yaf_UserAlbumImages", ThisKey="AlbumID", OtherKey="AlbumID")]
	...
	[Table(Name="dbo.yaf_UserAlbumImage")]
    ...
    partial void OnDownloadsChanged();
		...
		[Column(Storage="_Caption", DbType="NVarChar(255)")]
		...
		[Column(Storage="_Uploaded", DbType="DateTime NOT NULL")]
		...
		[Association(Name="yaf_UserAlbum_yaf_UserAlbumImage", Storage="_yaf_UserAlbum", ThisKey="AlbumID", OtherKey="AlbumID", IsForeignKey=true)]
    ...
    partial void OnAcceptedChanged();
		...
		[Column(Storage="_Invited", DbType="DateTime NOT NULL")]
		...
		[Association(Name="yaf_AccessMask_yaf_UserForum", Storage="_yaf_AccessMask", ThisKey="AccessMaskID", OtherKey="AccessMaskID", IsForeignKey=true)]
		public yaf_AccessMask yaf_AccessMask
		{
			get
			{
		...
		[Association(Name="yaf_Forum_yaf_UserForum", Storage="_yaf_Forum", ThisKey="ForumID", OtherKey="ForumID", IsForeignKey=true)]
		public yaf_Forum yaf_Forum
		{
			get
			{
		...
		[Association(Name="yaf_User_yaf_UserForum", Storage="_yaf_User", ThisKey="UserID", OtherKey="UserID", IsForeignKey=true)]
		public yaf_User yaf_User
		{
			get
			{
    ...
    partial void OnGroupIDChanged();
		...
		[Association(Name="yaf_Group_yaf_UserGroup", Storage="_yaf_Group", ThisKey="GroupID", OtherKey="GroupID", IsForeignKey=true)]
		public yaf_Group yaf_Group
		{
			get
			{
		...
		[Association(Name="yaf_User_yaf_UserGroup", Storage="_yaf_User", ThisKey="UserID", OtherKey="UserID", IsForeignKey=true)]
		public yaf_User yaf_User
		{
			get
			{
	...
	public partial class yaf_UserMedal
	{
		...
		[Column(Storage="_DateAwarded", DbType="DateTime NOT NULL")]
	...
	[Table(Name="dbo.yaf_UserPMessage")]
    ...
    partial void OnIsDeletedChanged();
		...
		[Column(Storage="_UserPMessageID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_PMessageID", DbType="Int NOT NULL")]
		public int PMessageID
		{
			get
			{
		...
		[Column(Storage="_IsRead", AutoSync=AutoSync.Always, DbType="Bit", IsDbGenerated=true, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_IsInOutbox", AutoSync=AutoSync.Always, DbType="Bit", IsDbGenerated=true, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_IsArchived", AutoSync=AutoSync.Always, DbType="Bit", IsDbGenerated=true, UpdateCheck=UpdateCheck.Never)]
		...
		[Association(Name="yaf_PMessage_yaf_UserPMessage", Storage="_yaf_PMessage", ThisKey="PMessageID", OtherKey="PMessageID", IsForeignKey=true)]
		...
		[Association(Name="yaf_User_yaf_UserPMessage", Storage="_yaf_User", ThisKey="UserID", OtherKey="UserID", IsForeignKey=true)]
		public yaf_User yaf_User
		{
			get
			{
    ...
    partial void OnLastMailChanged();
		...
		[Column(Storage="_WatchForumID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Association(Name="yaf_Forum_yaf_WatchForum", Storage="_yaf_Forum", ThisKey="ForumID", OtherKey="ForumID", IsForeignKey=true)]
		public yaf_Forum yaf_Forum
		{
			get
			{
		...
		[Association(Name="yaf_User_yaf_WatchForum", Storage="_yaf_User", ThisKey="UserID", OtherKey="UserID", IsForeignKey=true)]
		public yaf_User yaf_User
		{
			get
			{
