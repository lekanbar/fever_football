    ...
    public class UploadHelper : System.Web.UI.Page
    {
        ...
        public static string UploadPicture(FileUpload file)
        {
            ...
            if (!string.IsNullOrEmpty(URL))
            {
                ...
                bool IsResized = manipulator.ResizePicture(URL, URL, 612, 459);
        ...
        public static string UploadGalleryPicture(FileUpload file)
        {
            ...
            if (!string.IsNullOrEmpty(URL))
            {
                ...
                IsResized = manipulator.ResizePicture(ThumbURL, ThumbURL, 100, 80);
        ...
        public static string UploadGalleryPicture(HttpPostedFile file)
        {
            ...
            if (!string.IsNullOrEmpty(URL))
            {
                ...
                bool IsResized = manipulator2.ResizePicture(ThumbURL, ThumbURL, 100, 80);
                IsResized = manipulator.ResizePicture(URL, URL, 612, 459);
