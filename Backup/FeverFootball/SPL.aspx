<%@ Page Language="C#" MasterPageFile="~/MasterPageSPL.master" AutoEventWireup="true" CodeFile="SPL.aspx.cs" Inherits="EPl" Title="Untitled Page" %>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <span class="largeLinks2"> 
                                ...
                                NavigateUrl='<%# "SPLDetail.aspx?id=" + Eval("NewsID")  %>' >
                                     <%# Eval("Title") %>                                      
                                   </asp:HyperLink> 
                                   </b>  
                                   <br />
