<%@ Page Language="C#" MasterPageFile="~/MasterPageGPL.master" AutoEventWireup="true" CodeFile="GPL.aspx.cs" Inherits="EPl" Title="Untitled Page" %>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <span class="largeLinks2"> 
                                ...
                                NavigateUrl='<%# "GPLDetail.aspx?id=" + Eval("NewsID")  %>' >
                                     <%# Eval("Title") %>                                      
                                   </asp:HyperLink> 
                                   </b>  
                                   <br />
