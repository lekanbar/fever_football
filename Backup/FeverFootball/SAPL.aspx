<%@ Page Language="C#" MasterPageFile="~/MasterPageSAPL.master" AutoEventWireup="true" CodeFile="SAPL.aspx.cs" Inherits="EPl" Title="Untitled Page" %>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <span class="largeLinks2"> 
                                ...
                                NavigateUrl='<%# "SAPLDetail.aspx?id=" + Eval("NewsID")  %>' >
                                     <%# Eval("Title") %>                                      
                                   </asp:HyperLink> 
                                   </b>  
                                   <br />
