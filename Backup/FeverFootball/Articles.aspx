<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Articles.aspx.cs" Inherits="_Default" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="mainColumn">
            ...
            <asp:GridView ID="GVArticles" runat="server" Width="100%" GridLines="None"  ShowHeader="false"
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <span class="largeLinks"> 
                                ...
                                NavigateUrl='<%# "ArticlesDetail.aspx?id=" + Eval("ArticleID")  %>' >
                                     <%# Eval("Title") %>                                      
                                   </asp:HyperLink> 
                                   </b>  
                                   <br />
                                   ...
                                   <%# shortner( Eval("Details").ToString(),300) %>
                                   <span class="date">
