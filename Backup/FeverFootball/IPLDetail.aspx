<%@ Page Language="C#" MasterPageFile="~/MasterPageIPL.master" AutoEventWireup="true" CodeFile="IPLDetail.aspx.cs" Inherits="EPl" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <div>
    ...
    <asp:Panel ID="PanelMain" runat="server">
        ...
        <br /><br />   
       <b> <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="IPL.aspx"> VIEW ALL NEWS UPDATES</asp:HyperLink></b>
