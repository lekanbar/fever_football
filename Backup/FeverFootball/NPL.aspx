<%@ Page Language="C#" MasterPageFile="~/MasterPageNPL.master" AutoEventWireup="true" CodeFile="NPL.aspx.cs" Inherits="EPl" Title="Untitled Page" %>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <span class="largeLinks2"> 
                                ...
                                NavigateUrl='<%# "NPLDetail.aspx?id=" + Eval("NewsID")  %>' >
                                     <%# Eval("Title") %>                                      
                                   </asp:HyperLink> 
                                   </b>  
                                   <br />
