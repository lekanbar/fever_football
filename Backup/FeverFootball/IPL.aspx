<%@ Page Language="C#" MasterPageFile="~/MasterPageIPL.master" AutoEventWireup="true" CodeFile="IPL.aspx.cs" Inherits="EPl" Title="Untitled Page" %>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <span class="largeLinks2"> 
                                ...
                                NavigateUrl='<%# "IPLDetail.aspx?id=" + Eval("NewsID")  %>' >
                                     <%# Eval("Title") %>                                      
                                   </asp:HyperLink> 
                                   </b>  
                                   <br />
