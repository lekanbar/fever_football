<%@ Page Language="C#" MasterPageFile="~/MasterPageGPL.master" AutoEventWireup="true" CodeFile="GPLDetail.aspx.cs" Inherits="EPl" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <div>
    ...
    <asp:Panel ID="PanelMain" runat="server">
        ...
        <br />	  
        <br />   
       <b> <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="GPL.aspx"> VIEW ALL NEWS UPDATES</asp:HyperLink></b>
