<%@ Page Language="C#" MasterPageFile="~/MasterPageCPL.master" AutoEventWireup="true" CodeFile="CPLDetail.aspx.cs" Inherits="EPl" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <div>
    ...
    <asp:Panel ID="PanelMain" runat="server">
        ...
        <br /> <br />   
       <b> <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="CPL.aspx"> VIEW ALL NEWS UPDATES</asp:HyperLink></b>
